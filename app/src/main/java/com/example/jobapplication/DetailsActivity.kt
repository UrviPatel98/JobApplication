            ...
            override fun onClick(view: View?) {
                if (prif[IS_LOGIN]!!) {
                    ...
                    sharingIntent.putExtra(
                        Intent.EXTRA_TEXT,
                        "Company Name:" + intent.getStringExtra("COMPANY_NAME") + "\n" + " Post: " + intent.getStringExtra(
                            "POST"
                        ) + "\n"
                                + " Education:" + intent.getStringExtra("EDUCATION") + "\n" + "Location: " + intent.getStringExtra(
                            "LOCATION"
                        ) + "\n" +
                    ...
                    Toast.makeText(this@DetailsActivity, getString(R.string.lbl_you_r_not_logged_in_what_to_login), Toast.LENGTH_SHORT).show()
